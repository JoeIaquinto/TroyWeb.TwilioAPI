...
{
    [LocalizedDisplayName(nameof(Resources.GetNextAvailableMobilePhoneNumberPage_DisplayName))]
    [LocalizedDescription(nameof(Resources.GetNextAvailableMobilePhoneNumberPage_Description))]
    public class GetNextAvailableMobilePhoneNumberPage : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        public GetNextAvailableMobilePhoneNumberPage()
        {
            Constraints.Add(ActivityConstraints.HasParentType<GetNextAvailableMobilePhoneNumberPage, TwilioApiScope>(string.Format(Resources.ValidationScope_Error, Resources.TwilioApiScope_DisplayName)));
        }
