...
{
    [LocalizedDisplayName(nameof(Resources.GetPreviousAvailableTollFreePhoneNumberPage_DisplayName))]
    [LocalizedDescription(nameof(Resources.GetPreviousAvailableTollFreePhoneNumberPage_Description))]
    public class GetPreviousAvailableTollFreePhoneNumberPage : ContinuableAsyncCodeActivity
    {
        #region Properties
        ...
        public GetPreviousAvailableTollFreePhoneNumberPage()
        {
            Constraints.Add(ActivityConstraints.HasParentType<GetPreviousAvailableTollFreePhoneNumberPage, TwilioApiScope>(string.Format(Resources.ValidationScope_Error, Resources.TwilioApiScope_DisplayName)));
        }
